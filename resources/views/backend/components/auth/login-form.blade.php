                    ...
                    <div class="p-2 mt-4">
                        ...
                        <div class="mt-4 text-center">
                            ...
                            <div>
                                ...
                                <button class="btn btn-danger btn-icon waves-effect waves-light"><i
                                        class="ri-google-fill fs-16"></i></button>
                                <button class="btn btn-dark btn-icon waves-effect waves-light"><i
                                        class="ri-github-fill fs-16"></i></button>
                                <button class="btn btn-info btn-icon waves-effect waves-light"><i
