    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Update Flight</h6>
                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-12 mb-2 form-group">
                                    ...
                                    <input oninput="oldImg.src=window.URL.createObjectURL(this.files[0])"  type="file" class="form-control" id="ImgUpdate">
                                </div>                              
...
@push('per_page_js')
    ...
    <script>
        ...
        var guard = "{{ guardCheck() }}"
            ...
            showLoader();
            let res = await axios.post(`/${guard}dashboard/custom_module/flights/edit`,{id:id})
