                    ...
                    <div class="row justify-content-between ">
                        ...
                        <div class="align-items-center col">   
                            @if(can('add_team') || (request()->header('role') == 'superadmin'))                                 
                                <button data-bs-toggle="modal"  data-bs-target="#create-modal" class="btn btn-success float-end  m-0 ">Add Team</button>
                            @endif                
...
@push('per_page_js')
    ...
    <script>
        ...
        async function  getTeamList() {
            ...
            let res = await axios.get(`/${guard}dashboard/teams/team-data`);
            ...
            $('.editBtn').on('click', async function () {                
                ...
                await FillTeamUpUpdateForm(id,filePath)
