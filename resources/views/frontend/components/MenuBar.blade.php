  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{ route('landing.page') }}" class="logo me-auto"><img id="MenuLogo" src="" alt="" class="img-fluid"></a>
  ...
  <script>
    ...
    async function AppSettingsData(){            
          ...
          document.getElementById("MenuLogo").src = "{{ asset('assets/images') }}/" + res.data['data']['logo'];
      }
